...
<section class="hero-area overlay" style="background-image: url('images/banner/hero-area.jpg');">
	...
	<div class="block">
		...
		<h4>Small Help Can Make Change</h4>
		<h1>New hope for
            near future</h1>
			<p>Your small contribution means a lot. Natus officia amet hic
				accusamus repellat magni reprehenderit dolorem.</p>
			<a data-scroll href="donationpage.php" class="btn btn-transparent">Donate</a>
	</div>
</section>
		 ...
		 <header id="navigation" class="navbar navigation">
			   ...
			   <nav class="collapse navbar-collapse navbar-right" role="Navigation">
				   <ul id="nav" class="nav navbar-nav navigation-menu">
					   ...
					   <li><a data-scroll href="#services">Causes</a></li>
					   <li><a data-scroll href="#portfolio">Gallary</a></li>
					   <li><a data-scroll href="#our-team">Team</a></li>
					   <li><a data-scroll href="#blog">Blog</a></li>
					   <li><a data-scroll href="donationpage.php">Donate</a></li>
				   </ul>
			   </nav>
			   <!-- /main nav -->
					...
					<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" >
						<div class="block">							
							...
							<div class="content text-center">
								<h3 class="ddd">Worldwide Charity </h3>								
								<p>NGO, is an organization that is, generally, formed independent from government.They are typically nonprofit entities, and many of them are active in humanitarianism or the social sciences; they can also include clubs and associations that provide services to their members and others. Surveys indicate that NGOs have a high degree of public trust, which can make them a useful proxy for the concerns of society and stakeholders.</p>
							</div>
						</div>
					</div> 
					<!-- End About item -->
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 padding-0 ">
				<img class="img-responsive" src="images/banner/two.jpg" alt="">
			</div>
			<div class="col-md-6">
				<div class="content-block">
					<h2>You are definitely intrigued to
						...
						<div class="col-md-6">
							<div class="media">
								...
								<div class="media-body">
									<h4 class="media-heading">Worldwide Charity</h4>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<a href="donationpage.php" class="btn btn-main">Donate</a>
			</div>
		</div> 		<!-- End row -->
	</div>   	<!-- End container -->
</section>   <!-- End section -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2><span class="color">Causes</span></h2>
				<div class="border"></div>
			</div>
			<!-- /section title -->
	...
	<div class="container">
		...
		<div class="row filtr-container">
			...
			<div class="filtr-item col-md-4" data-category="design">
				<div class="portfolio-block">
					<img class="img-responsive" src="portfolio_image/portfolio-2.jpg" alt="">
				uuu	<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfolio/portfolio-2.jpg"
							data-lightbox="image-1">
u<i class="tf-ion-android-search"></i>
						</a>
						<h4><a href="">Donnating Books</a></h4>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
					</div>
				</div>
			</div>
		...
		<div class="all-post text-center">
				<a class="btn btn-main" href="blog.html">More Works</a>
			</div>
	</div>   	<!-- end container -->
</section>   <!-- end section -->
					...
					<div class="member-photo">
						...
						<div class="mask">
							...
							<li><a href="https://facebook.com"><i class="tf-ion-social-facebook"></i></a></li>
								...
								<li><a href="https://linked.com"><i class="tf-ion-social-linkedin"></i></a></li>
				...
				<div id="testimonials" class="wow fadeInUp" data-wow-duration="500ms" data-wow-delay="100ms">
					...
					<div class="item text-center">
						...
						<div class="client-thumb">
							<img src="images/team/client-1.jpg" class="img-responsive" alt="">
						</div>
						<!-- /client photo -->
					...
					<div class="item text-center">
						...
						<!-- client photo -->
						<div class="client-thumb">
							<img src="images/team/client-2.jpg" class="img-responsive" alt="">
						</div>
						<!-- /client photo -->
		...
		<div class="row">
			...
			<div class="clearfix">
				...
				<article class="col-md-4 col-sm-6 col-xs-12 clearfix wow fadeInUp" data-wow-duration="500ms">
					<div class="post-block">
						<div class="media-wrapper">
							<img src="images/blog/blog-post1.png" alt="Book Donating" class="img-responsive">
						</div>
						<div class="content">
							<h3><a href="">Donates Books</a></h3>
							...
							<a class="btn btn-transparent" href="donationpage.php">Donate</a>
						</div>
					</div>						
				</article>
				<!-- /single blog post -->
				...
				<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
					<div class="post-block">
						<div id="gallery-post" class="media-wrapper">
							<div class="item">
								<img src="images/blog/blog-post2.jpg" alt="blog post" class="img-responsive">
							</div>
							<div class="item">
								<img src="images/blog/blog-post3.jpg" alt="blog post" class="img-responsive">
							</div>
							<div class="item">
								<img src="images/blog/blog-post4.jpg" alt="blog post " class="img-responsive">
							</div>
						</div>
						
						<div class="content">
							<h3><a href="">Always Happy</a></h3>
							<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non skateboard dolor brunch.</p>
							<a class="btn btn-transparent" href="donationpage.php">Donate</a>
						</div>
					</div>						
				...
				<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
					<div class="post-block">
						<div class="media-wrapper">
							<img src="images/blog/blog-post5.jpg" alt="blog post" class="img-responsive">
						</div>
						
						<div class="content">
							<h3><a href="">Going on tours</a></h3>
							<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non skateboard dolor brunch.</p>
							<a class="btn btn-transparent" href="donationpage.php">Donate</a> 
						</div>
					</div>						
		...
		<div class="row wow fadeInUp" data-wow-duration="500ms">
			<div class="col-lg-12">
				...
				<div class="copyright text-center">
					...
					<p>Thank you for vist here <script>
